  ...
  var
    ...
    renderNotification = function(data) {
      ...
      notification.addEventListener("click", function() {
        updateMapCentre(data.position);
      });
    },

    //Adds socket listeners for posting and commenting
    ...
    //Draws the users position on the map
    ...
    //Draws a marker for a notification
    ...
    //Updates the users position on the map
    ...
    //Sets the title at the top of the map page
