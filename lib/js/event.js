...
window.eventNet.events = (function() {
  ...
  var
    ...
    renderNetwork = function(listElement, data) {
      ...
      eventDistance.innerHTML = beautifyDistance(parseInt(data.distanceFromUser)) + " away";
    ...
    renderNetworks = function(response) {
      ...
      setTimeout(selectEventFromSavedData, 250);
    ...
    createNetwork = function(e) {
      var nameField = document.getElementById("new-event-name");
