  ...
  var
    ...
    createPost = function(event) {
      ...
      window.eventNet.xhr.load({
        ...
        payload: {
          eventId: eventId,
          accessToken: window.eventNet.core.getUserToken(),
          postContent: content,
    ...
    loadCommentsOnUpdate = function(postId) {
    ...
    loadComments = function(postId, commentList, limit, offset) {
      ...
      var url = "api/v1/comments?postId=" + postId + "&accessToken=" + window.eventNet.core.getUserToken() + "&offset=" + offset;
    ...
    loadPosts = function(loadNew) {
      ...
      var url = "api/v1/posts?eventId=" + eventId + "&limit=100&accessToken=" + window.eventNet.core.getUserToken();
    ...
    addSocketListeners = function() {
      ...
      window.eventNet.core.addSocketListener("newComment", function(data) {
        ...
        loadCommentsOnUpdate(data.postId);
      });
    },
