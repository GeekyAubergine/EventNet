...
window.eventNet.feed = (function() {
  ...
  var
    ...
    toggleWriteCommentSection = function(event) {
      ...
      window.eventNet.ui.toggleDivVisibility(writeCommentSection);
    },
    ...
    listComments = function(post, data, autoHide) {
    ...
    loadComments = function(post, postData, offset, amount, autoHide) {
    ...
    addPost = function(postList, postData, appendToEnd) {
      ...
      var writeCommentSection = window.eventNet.util.append(contentContainer, "div");
      writeCommentSection.classList.add("post");
      writeCommentSection.classList.add("comment-creator");
      writeCommentSection.classList.add("hidden");

      var commentSectionUserIcon = window.eventNet.util.append(writeCommentSection, "div");
      commentSectionUserIcon.classList.add("user-icon-container");

      var userImage = window.eventNet.util.append(commentSectionUserIcon, "img");
      userImage.src = window.eventNet.core.getUserImage();

      var writeCommentSectionContainer = window.eventNet.util.append(writeCommentSection, "div");
      writeCommentSectionContainer.classList.add("content-container");
      ...
      var writeCommentSectionButtonContainer = window.eventNet.util.append(writeCommentSectionContainer, "div");
      writeCommentSectionButtonContainer.classList.add("button-container");

      var writeCommentSectionCommentButton = window.eventNet.util.append(writeCommentSectionButtonContainer, "a");
      writeCommentSectionCommentButton.classList.add("button");
      writeCommentSectionCommentButton.classList.add("commentButton");
